...
public class CurrentOpportunitiesReportGenerationSql {
   ...
   public static final String marginSetOppurtunityWiseSql = "select charge_out_rate,resource_salary from rts_req_res_status_tracking_details where rts_tracking_details_id = ? ";
}
