...
public class UserProfileSql {
   ...
   public static final String fetchUserDeatils = "select * from rts_user_master where is_delete = 'N' ";
   ...
   public static final String countNumberSql = "select count(*) from rts_user_master where user_id = ? and password = ? ";
