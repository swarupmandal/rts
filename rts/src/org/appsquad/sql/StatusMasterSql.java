...
public class StatusMasterSql {
	public static final String insertStatusQuery = "INSERT INTO rts_status_master(created_by,master_status_name,is_pre_bill)VALUES (?,?,?) ";
    ...
    public static final String updateStatusSql = "update rts_status_master set master_status_name = ?,is_pre_bill = ? where id = ? ";
